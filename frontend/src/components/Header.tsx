...
const NoneTextDecorationLink = (props: {
  to: string;
    ...
    <>
      ...
      >
        <MenuItem onClick={handleClose}>
          <NoneTextDecorationLink to="/logout">Logout</NoneTextDecorationLink>
        </MenuItem>
      </Menu>
    </>
  );
...
export const Header = (props: { user?: User; title: string }): JSX.Element => {
